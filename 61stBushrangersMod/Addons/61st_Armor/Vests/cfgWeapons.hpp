	...
	class BR_V_RSV_PLAIN_DEMO: BR_V_RSV_PLAIN
	{
        scope=2;
        scopeArsenal=2;
		dlc="61st";
		author="TakenFTG";
		displayName="[61st] Reservist Vest (Demolitions)";
		hiddenSelections[]=
        {
            "Camo1", //CQB Left
            "Camo2", //CQB Right
	...
	class BR_V_RSV_PLAIN_MARKSMAN: BR_V_RSV_PLAIN
	{
        scope=2;
        scopeArsenal=2;
		dlc="61st";
		author="TakenFTG";
		displayName="[61st] Reservist Vest (Marksman)";
		hiddenSelections[]=
        {
            "Camo1", //CQB Left
            "Camo2", //CQB Right
	...
	class BR_V_RSV_PLAIN_SNIPER: BR_V_RSV_PLAIN
	{
		scope=2;
        scopeArsenal=2;
		dlc="61st";
		author="TakenFTG";
		displayName="[61st] Reservist Vest (Sniper)";
		hiddenSelections[]=
        {
            "Camo1", //CQB Left
            "Camo2", //CQB Right
