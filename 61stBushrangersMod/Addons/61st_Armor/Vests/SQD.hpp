    class BR_V_SQD_CO: BR_V_RSV_PLAIN
    {
        scope = 2;
        scopeArsenal = 2;
        dlc = "61st";
        author = "TakenFTG";
        displayName = "[61st] Squadron Vest (CO)";
    ...
    class BR_V_SQD_XO: BR_V_RSV_PLAIN
    {
        scope = 2;
        scopeArsenal = 2;
        dlc = "61st";
        author = "TakenFTG";
        displayName = "[61st] Squadron Vest (XO)";
        picture = "\optre_unsc_units\army\icons\odst_vest";
        model = "MA_Armor\data\Vests\M52_ODST\M52_ODST_Vest.p3d";
    ...
    class BR_V_SQD_WOFF: BR_V_RSV_PLAIN
    {
        scope = 2;
        scopeArsenal = 2;
        dlc = "61st";
        author = "TakenFTG";
        displayName = "[61st] Squadron Vest (WOFF)";
        picture = "\optre_unsc_units\army\icons\odst_vest";
        model = "MA_Armor\data\Vests\M52_ODST\M52_ODST_Vest.p3d";
    ...
    class BR_V_SQD_PLAIN: BR_V_RSV_PLAIN
    {
        scope = 2;
        scopeArsenal = 2;
        dlc = "61st";
        author = "TakenFTG";
        displayName = "[61st] Squadron Vest (Plain)";
        picture = "\optre_unsc_units\army\icons\odst_vest";
        model = "MA_Armor\data\Vests\M52_ODST\M52_ODST_Vest.p3d";
